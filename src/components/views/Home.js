        ...
        <Grid item xs={12} md={7} textAlign={"center"}>
          <Box p={5} boxShadow={2} style={{ height: "100%" }}>
            <Typography display={"block"}>
              If you want to create a new event from scratch with your friends,
              you can first create a lobby. You can do this by navigating to the
              Lobbies page and then clicking on the create new lobby button. You
              can directly navigate to the Lobbies page by clicking on the
              following button:
            </Typography>
            <Button
              variant={"contained"}
