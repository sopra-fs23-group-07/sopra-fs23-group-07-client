      ...
      <BaseContainer className="lobby">
        <div className="flex space-x-10">
          <div className="w-[80%]">
            ...
            >
              <ol>
                <Tooltip title="                For a more detailed describtion see at the bottom of the page ">
                  <HelpOutline
            ...
            >
              <ol>
                ...
                <ul>
                  <li>
                    <strong style={{ color: "blue" }}> Sport: </strong>You can
                    select multiple sports and you should choose all sports you
                    like to do. So you can find a sport that you have common
                    with the other users in the lobby.
                  </li>
                  <li>
                    <strong style={{ color: "blue" }}> Time and Date: </strong>
                    Here you can select multiple timeslots and you should select
                    like explained for sports above. To select a timeslot you
                    first have to press on it and afterwards hit the checkmark.
                  </li>
                  <li>
                    <strong style={{ color: "blue" }}>Location:</strong> Here
                  ...
                  <ul>
                    ...
                    <li>
                      Option 2: Suggest a location yourself by clicking on the
                      map where you want the event to take place. Then press
                      confirm location and vote for it.
                    </li>
                    <li>
                      If you have already voted but want to change your vote you
                      first have to unvote before you can vote for a different
                      location.
                    </li>
                  </ul>
                </ul>
                ...
                <li>
                  <strong style={{ color: "blue" }}>Lock your choice: </strong>
                  If you are happy with all your choices lock them. After you
                  locked your choice you can't edit your preferences for sport,
                  timeslot and location anymore. If you change your mind about
                  one of the preferences you can unlock and then edit your
                  choices.
                </li>
                <li>
                  ...
                  Either when all users in the lobby have locked their choices
                  or when the timer <Schedule />
                  hits zero.
                </li>
              </ol>
            </div>
